	...
	public static function alert_box( $atts, $content = null){
		...
		if ($icon == 'yes'):
			switch($color){
                ...
                $output = <<<HTML
                <div data-alert class="wpfs alert-box type-{$type_val} {$domain} {$color} {$corners} {$custom_class}">{$font_icon}{$alertContent}{$close_btn}</div>
HTML;
                return $output;
	}
...
HTML;
	...
	public static function button( $atts, $content = null){
		...
		$output = <<<HTML
			{$tag_open} class="wpfs button {$color} {$corners} {$size} {$custom_class}">{$font_icon}{$buttonContent}{$tag_close}
HTML;
                return $output;
	}
...
HTML;
	...
	// button groups
		...
		$buttonGroupsContent = ($content) ? do_shortcode($content) : '';
                $output = <<<HTML
			<ul class="wpfs button-group {$corners} {$custom_class}">
				{$buttonGroupsContent}
			</ul>
HTML;
                return $output;
		...
		extract(shortcode_atts(
                ...
                $output = <<<HTML
			<li><a href="{$url}" class="button {$color} {$size}">{$buttonGroupContent}</a></li>
HTML;
                return $output;
        }
