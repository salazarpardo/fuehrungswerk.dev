...
<div class="wrap wp-foundation-shortcodes-admin-page">
	...
	<form method="post" action="<?php echo admin_url('options.php');?>">
                ...
                <p><?php _e('You should enable it to work <strong>[google_map]</strong> and <strong>[slick_slider]</strong> shortcodes. It is important to not upload unnecessary CSS and JS.', 'wp-foundation-shortcodes')?></p>
