...
3. [blockquote author="Cicero" custom_class="my_custom_class"]At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio[/blockquote]
4. [icon icon="fa-warning" size="40px" color="red" custom_class="my_custom_class"]Alert[/icon]
5. [range_slider direction="horizontal" corners="radius" custom_class="my_custom_class" initial_value="10" start_value="0" end_value="100" step="0"]
6. [address title="Gaius Baltar" custom_class="my_custom_class"]123 Colonial Ave.
Caprica City
Caprica, 12345
g.baltar@example.com[/address]
7. [alert_box color="alert" corners="radius" custom_class="my_custom_class" icon="fa-exclamation-triangle" close="yes"]This is an alert with radius corners[/alert_box]
...
9. [pricing_table title="Standard" price="$99.99" description="An awesome description" item_name_1="1 Database" item_name_2="5GB Storage" item_name_3="20 Users" button_text="Buy Now" link="#" target="_blank" custom_class="my_custom_class"]
10. [progressbar value="60" color="success" corners="round" custom_class="my_custom_class"]
...
13. [tabs direction="horizontal" custom_class="my_custom_class"][tab title='Title #1'] Tab 1 content... [/tab] [tab title='Title #2'] Tab 2 content... [/tab] [tab title='Title #3'] Tab 3 content... [/tab][/tabs]
